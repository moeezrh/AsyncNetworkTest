...
async def main():
    ...
    outputSummaryFile = output_path
    outputEventFile = output_path
    ...
    for each_file in os.listdir(temp_path):
        ...
        with open(each_file, "r") as source_file, open(outputEventFile, "a") as destination_file:
